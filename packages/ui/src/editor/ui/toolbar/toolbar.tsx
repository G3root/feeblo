...
export default function Toolbar(props: { uploader?: Uploader<string> }) {
  ...
  return (
    <div className="z-2 box-border border-gray-200 dark:border-gray-800 border-solid border-s-0 border-e-0 border-t-0 border-b flex flex-wrap gap-1 p-2 items-center">
      {items.undo && (
        <Button
