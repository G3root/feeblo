...
CREATE UNIQUE INDEX "email_outbox_pendingStatusAggregate_uidx" ON "email_outbox" ("organization_id","kind","aggregate_id") WHERE "state" = 'pending' AND "kind" = 'post.status_changed';--> statement-breakpoint
...
CREATE INDEX "email_subscription_state_organizationId_idx" ON "email_subscription" ("state","organization_id");--> statement-breakpoint
...
ALTER TABLE "email_provider_event" ADD CONSTRAINT "email_provider_event_delivery_id_email_delivery_id_fkey" FOREIGN KEY ("delivery_id") REFERENCES "email_delivery"("id") ON DELETE CASCADE;--> statement-breakpoint
