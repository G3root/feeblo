...
ALTER TABLE "post_tag" ADD CONSTRAINT "post_tag_merged_from_post_id_post_id_fkey" FOREIGN KEY ("merged_from_post_id") REFERENCES "post"("id") ON DELETE SET NULL;--> statement-breakpoint
