...
export const structFields = <
  A extends { readonly fields: Schema.Struct.Fields },
>(
  self: A
...
export interface GeneratedOptional<S extends Schema.Top>
  extends VariantSchema.Field<{
    readonly select: S;
 ...
 */
export const GeneratedOptional = <S extends Schema.Top>(
  schema: S
): GeneratedOptional<S> =>
  Field({
    select: schema,
...
export interface Immutable<S extends Schema.Top>
  extends VariantSchema.Field<{
    readonly select: S;
    readonly insert: S;
    readonly update: S;
...
export interface Date
  extends Schema.decodeTo<Schema.DateTimeUtc, Schema.String> {}
...
export interface DateTimeInsertFromDate
  extends VariantSchema.Field<{
    ...
    readonly insert: VariantSchema.Overrideable<
      typeof Schema.DateTimeUtcFromDate
    >;
    readonly json: typeof Schema.DateTimeUtcFromString;
  }> {}
...
export interface DateTimeInsertFromNumber
  extends VariantSchema.Field<{
    ...
    readonly insert: VariantSchema.Overrideable<
      typeof Schema.DateTimeUtcFromMillis
    >;
...
export type PartialStruct<S extends Schema.Top> =
  S extends Schema.Struct<infer F>
    ? Schema.Struct<{
        readonly [K in keyof F]: Schema.optionalKey<F[K] & Schema.Top>;
      }>
    : never;
...
export const JsonDate = Schema.Union([
  Schema.DateTimeUtcFromString,
  Schema.Date,
]).pipe(
  Schema.annotate({
