...
const makeFakeSlackApiClient = (): SlackApiClient & {
    ...
    conversationsList: () =>
      Effect.succeed({
        channels: [
          ...
          { id: "C2", is_archived: false, is_member: true, name: "feedback" },
          { id: "C3", is_archived: false, is_member: false, name: "other" },
        ],
        ok: true as const,
      }),
    oauthV2Access: () => {
...
const makeTestLayer = () => {
  const apiClient = makeFakeSlackApiClient();
