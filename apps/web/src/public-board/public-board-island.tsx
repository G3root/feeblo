 ...
 *
 * The board package compiles its own messages with the `baseLocale` fallback
 * strategy, so the host must inject its locale runtime. `client:only` keeps
 * this module out of the server render, and the app's cookie-based strategy
