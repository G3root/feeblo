...
function IntegrationsSettingsRoute() {
  ...
  // Surface the result of the Slack OAuth install flow the server redirected
  // back with, then strip the query params so the notice shows only once.
  useEffect(() => {
  ...
  }, [organizationId, router, search.message, search.slack]);
