/** biome-ignore-all lint/style/noNestedTernary: ignore for now */
...
type IconSvgObject = typeof AlertCircleIcon;

type ToastType = "error" | "info" | "loading" | "success" | "warning";

const TOAST_ICONS: Record<ToastType, IconSvgObject> = {
...
function Toasts({ position = "bottom-right" }: { position: ToastPosition }) {
  ...
  return (
    <Toast.Portal data-slot="toast-portal">
      ...
      >
        {toasts.map((toast) => {
          const toastIcon: IconSvgObject | null = toast.type
            ? TOAST_ICONS[toast.type as ToastType]
            : null;
