...
- **Provider**: an external integration family. V1 implements the `webhook` provider only.
...
- **Binding**: a future durable local-to-remote entity relationship used by bidirectional sync. It is not implemented for V1.
