...
This skill builds on the tanstack-db skill. Read it first for the overall mental model.
...
See also: ../mutations-optimistic/SKILL.md — mutation handlers configured here execute during mutations.

See also: ../custom-adapter/SKILL.md — for building your own adapter.
